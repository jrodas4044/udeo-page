  ...
  return (
    <div>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
            <div className="lg:w-1/2">
              ...
              <a href="#contact" className="inline-block bg-udeo-red hover:bg-udeo-red-dark text-white font-bold py-3 px-8 rounded-md hover: transition-all duration-300">
                ¡Inscríbete hoy!
              </a>
            </div>
      ...
      <section className="bg-udeo-charcoal py-14 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl text-white">Todo lo que necesitas saber</h2>
            <div className="w-16 h-1 bg-udeo-gold mx-auto mt-4 rounded-md" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">

            {/* Requisitos */}
            <div className="bg-white/5 border border-white/10 rounded-md p-6 hover:border-udeo-gold/30 transition-all duration-300">
