...
export default function Footer() {
  return (
    <div className="bg-udeo-red-dark text-white">
      <footer className="mx-auto px-4 py-12 container">
        <div className="gap-8 grid grid-cols-1 md:grid-cols-3">
          ...
          <div className="space-y-4">
            <h3 className="mb-4 font-bold text-2xl text-udeo-gold">
              Contacto
            </h3>
            <div className="space-y-2">
              <p>
                <strong className="text-udeo-gold-light">Email:</strong>{" "}
                informacion@udeoberistain.edu.gt
              </p>
              <p>
                <strong className="text-udeo-gold-light">PBX:</strong> +(502)
                2458-4551
              </p>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  ...
                  className="hover:text-udeo-gold-light transition-colors"
                >
      ...
      <div className="bg-udeo-charcoal py-4 text-center">
